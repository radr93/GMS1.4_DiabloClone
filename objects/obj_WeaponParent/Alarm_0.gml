...
if (item[property.object] == -1){
    item[property.equipslot] = equipslot.weapon;
    ...
    if (item[property.rarity] == rarity.magic){
        ...
        if (chance == 1){
            item[property.prop1stat] = scr_AssignWeapon();
        ...
        if (chance == 2){
            ...
            item[property.prop1stat] = scr_AssignWeapon(item[property.prop1stat]);
            item[property.prop1stattext] = scr_AssignPropText(item[property.prop1stat]);
            item[property.prop1value] = scr_AssignPropValue(item[property.prop1stat], item[property.ilvl]);
            item[property.prop1] = ("+" + string(item[property.prop1value]) + " " + string(item[property.prop1stattext] + "#"));
        }
        ...
        if (chance == 3){
            ...
            item[property.prop2stat] = scr_AssignWeapon(item[property.prop1stat]);
    ...
    //If Rare
            ...
            item[property.prop2] = ("+" + string(item[property.prop2value]) + " " + string(item[property.prop2stattext] + "#"));
            //prop3
            item[property.prop3stat] = scr_AssignWeapon(item[property.prop1stat], item[property.prop2stat]);
            ...
            if (random(1) <= .5){
                //maybe prop4
                item[property.prop4stat] = scr_AssignWeapon(item[property.prop1stat], item[property.prop2stat], item[property.prop3stat]);
                ...
                if (random(1) <= .25){
                    //maybe prop5
                    item[property.prop5stat] = scr_AssignWeapon(item[property.prop1stat], item[property.prop2stat], item[property.prop3stat], item[property.prop4stat]);
                    ...
                    if (random(1) <= .25){
                        //maybe prop6        
                        item[property.prop6stat] = scr_AssignWeapon(item[property.prop1stat], item[property.prop2stat], item[property.prop3stat], item[property.prop4stat], item[property.prop5stat]);
