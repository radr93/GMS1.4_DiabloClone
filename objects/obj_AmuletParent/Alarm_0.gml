...
if (item[property.object] == -1){
    item[property.equipslot] = equipslot.amulet;
    item[property.type] = type.amulet;
    ...
    if (item[property.rarity] == rarity.magic){
        ...
        if (chance == 1){
            item[property.prop1stat] = scr_AssignJewelry();
        ...
        if (chance == 3){
            ...
            item[property.prop2stat] = scr_AssignJewelry(item[property.prop1stat]);
    ...
    //If Rare
            ...
            item[property.prop2] = ("+" + string(item[property.prop2value]) + " " + string(item[property.prop2stattext] + "#"));
            //prop3
            item[property.prop3stat] = scr_AssignJewelry(item[property.prop1stat], item[property.prop2stat]);
            ...
            if (random(1) <= .75){
                //maybe prop4
                item[property.prop4stat] = scr_AssignJewelry(item[property.prop1stat], item[property.prop2stat], item[property.prop3stat]);
                ...
                if (random(1) <= .5){
                    //maybe prop5
                    item[property.prop5stat] = scr_AssignJewelry(item[property.prop1stat], item[property.prop2stat], item[property.prop3stat], item[property.prop4stat]);
                    ...
                    if (random(1) <= .25){
                        //maybe prop6        
                        item[property.prop6stat] = scr_AssignJewelry(item[property.prop1stat], item[property.prop2stat], item[property.prop3stat], item[property.prop4stat], item[property.prop5stat]);
